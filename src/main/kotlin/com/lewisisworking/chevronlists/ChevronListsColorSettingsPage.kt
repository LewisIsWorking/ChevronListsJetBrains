...
class ChevronListsColorSettingsPage : ColorSettingsPage {
    ...
    companion object {
        private val DESCRIPTORS = arrayOf(
            ...
            AttributesDescriptor("Numbered digits (1., 2., ...)", ChevronListsAnnotator.NUMBER_KEY),
        ...
        private val TAG_TO_DESCRIPTOR_MAP = mapOf(
            ...
            "num"       to ChevronListsAnnotator.NUMBER_KEY,
        ...
        private val DEMO_TEXT = """
            ...
            <chev>>></chev> <num>1.</num> <phigh>!!!</phigh> Critical bug fix <tag>#urgent</tag> <date>@2026-04-22</date>
            <chev>>></chev> <num>2.</num> <pmed>!!</pmed> Deploy to staging <tag>#devops</tag>
            <chev>>></chev> <num>3.</num> <plow>!</plow> Update documentation <tag>#docs</tag>
